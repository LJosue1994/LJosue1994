...
<p align="center">
  Desarrollador Web Front-End · HTML · CSS · JavaScript · React  
  <br/>Apasionado por crear interfaces modernas y funcionales con enfoque en rendimiento y experiencia de usuario.
</p>
...
### 🚀 Sobre mí
- Soy un desarrollador web con experiencia técnica en **telecomunicaciones y sistemas**.  
- Me enfoco en construir **interfaces limpias, modernas y rápidas** usando HTML, CSS y JavaScript.  
- En proceso de fortalecer mis habilidades en **React y desarrollo de portafolios dinámicos**.  
- Combino mi experiencia técnica en **CCTV, fibra óptica y cableado estructurado** con mi pasión por el desarrollo web.
...
- **LuzNet Landing** — Landing corporativa responsive con hero, secciones y formulario.  
  🔗 [Ver repositorio](https://github.com/josuejolon/landing-luznet)
...
- **Portafolio React** — Componentes, rutas y animaciones suaves.  
  🔗 [Ver repositorio](https://github.com/josuejolon/portfolio-react)

> 💡 Sube imágenes de tus proyectos a `/assets` y agrégalas debajo de cada descripción.
